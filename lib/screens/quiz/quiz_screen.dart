        ...
        body: Consumer<QuizProvider>(
          builder: (context, quiz, _) {
            ...
            if (UserSharedPreferences.role == 'teacher') {
              ...
              quizzes =
                  showQuizList.map((element) => QuizModel.fromJson(element.toJson())).toList();
            } else {
            ...
            if (sort == 'All') {
              showQuizList =
                  quizzes.map((element) => QuizModel.fromJson(element.toJson())).toList();
